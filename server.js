// installed express, require here
...
// validate new data to ensure key exists and is the right type of data
...
// create route to get specific animal (parameter)
app.get('/api/animals/:id', (req, res) => {
    const result = findById(req.params.id, animals);
    if (result) {
      res.json(result);
    // if no record exists, send error message
    } else {
      res.send(404);
    }
});
